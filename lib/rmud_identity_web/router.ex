defmodule RmudIdentityWeb.Router do
  use RmudIdentityWeb, :router

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, {RmudIdentityWeb.Layouts, :root}
  ...
  # scope "/api", RmudIdentityWeb do
  #   pipe_through :api
  # end

  # Enable LiveDashboard and Swoosh mailbox preview in development
  if Application.compile_env(:rmud_identity, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: RmudIdentityWeb.Telemetry
